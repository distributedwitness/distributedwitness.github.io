...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php endif; ?>
			...
			<div class="invested-portfolio-index-hover<?php if (get_theme_mod( 'progression_portfolio_title') == 'visible') : ?> always-visible-portfolio<?php endif; ?><?php if (get_theme_mod( 'progression_portfolio_title') == 'hidden') : ?> never-visible-portfolio<?php endif; ?>">
